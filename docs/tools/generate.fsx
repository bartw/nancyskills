...
let website = "/nancyskills"

let githubLink = "http://github.com/bartw/nancyskills"

// Specify more information about your project
let info =
  [ "project-name", "nancyskills"
    "project-author", "Bart Wijnants"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/nancyskills" ]
